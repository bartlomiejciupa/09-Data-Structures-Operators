...
for (const [i, players] of games.scored.entries()) {
  console.log(` Gol nr ${i + 1}: ${players}`);
}

// 2.
let average = 0;

// for (const odd of Object.values(games.odds)) average += odd;
// average /= Object.values(games.odds).length;
// console.log(average);
...
for (const [team, odd] of Object.entries(games.odds)) {
  console.log(Object.entries(games.team1));
